...
class Base64Decode
{
    public static function decode($base64_string, $path, $document)
    {
        ...
        $baseUrlLocal = 'http://localhost:8001'; // Get base URL from Laravel config
        // $baseUrlDev = 'https://api.dev.mahawira.id';
        // $baseUrlProd = 'https://api.mahawira.id';
        
        $localUrl = $baseUrlLocal . '/storage/' . $subdirectory . '/' . $fileName;
